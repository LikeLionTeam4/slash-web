...
export const EXAMPLE_COMMANDS: ExampleCommand[] = [
  { id: '5bc2dc4e-96b2-4f06-bed0-059d2dbf66e4', icon: '☁️', path: ['네이버', '날씨'], query: '서울 날씨' },
  { id: '4a760c68-ace2-49df-a244-1ec2d179e065', icon: '🍜', path: ['네이버', '지도'], query: '강남역 맛집' },
  { id: '3efd142c-3d49-4445-910b-a154f8da3dd1', icon: '🔍', path: ['네이버'], query: '아이폰 16 가격' },
  { id: '399762aa-872d-4ab9-8f0a-68495b80c7c2', icon: '🧭', path: ['네이버', '길찾기'], query: '강남역에서 홍대입구역' },
  { id: 'f7cefac3-3a1e-4a57-a00c-5e40a0577fc1', icon: '📄', path: ['파일'], query: '견적서.pdf' },
]
